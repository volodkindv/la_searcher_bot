...
class TestSmokeTestGeneration:
    ...
    def test_generate_all_cases(self):
        """inspect all functions in src and generate test that creates all testcases"""
...
def test_{func_name}():
    ...
    def test_generate_all(self):
        ...
        self.generate_test_cases(
            ...
            'tests/smoke/test_api_get_active_searches_generated.py',
        )

        import archive_notifications.main

        self.generate_test_cases(
            archive_notifications.main, 'archive_notifications', 'tests/smoke/test_archive_notifications_generated.py'
        )

        import archive_to_bigquery.main

        self.generate_test_cases(
            archive_to_bigquery.main, 'archive_to_bigquery', 'tests/smoke/test_archive_to_bigquery_generated.py'
        )
        ...
        self.generate_test_cases(
            ...
            'tests/smoke/test_check_first_posts_for_changes_generated.py',
        )
        ...
        self.generate_test_cases(
            ...
            'tests/smoke/test_check_topics_by_upd_time_generated.py',
        )
        ...
        self.generate_test_cases(
            compose_notifications.main, 'compose_notifications', 'tests/smoke/test_compose_notifications_generated.py'
        )

        import connect_to_forum.main

        self.generate_test_cases(
            connect_to_forum.main, 'connect_to_forum', 'tests/smoke/test_connect_to_forum_generated.py'
        )
        ...
        self.generate_test_cases(
            ...
            'tests/smoke/test_identify_updates_of_first_posts_generated.py',
        )
        ...
        self.generate_test_cases(
            ...
            'tests/smoke/test_identify_updates_of_folders_generated.py',
        )
        ...
        self.generate_test_cases(
            ...
            'tests/smoke/test_identify_updates_of_topics_generated.py',
        )
        ...
        self.generate_test_cases(
            send_debug_to_admin.main, 'send_debug_to_admin', 'tests/smoke/test_send_debug_to_admin_generated.py'
        )

        import send_notifications.main

        self.generate_test_cases(
            send_notifications.main, 'send_notifications', 'tests/smoke/test_send_notifications_generated.py'
        )
        ...
        self.generate_test_cases(
            ...
            'tests/smoke/test_send_notifications_helper_generated.py',
        )
        ...
        self.generate_test_cases(
            ...
            'tests/smoke/test_send_notifications_helper_2_generated.py',
        )

        import title_recognize.main

        self.generate_test_cases(
            title_recognize.main, 'title_recognize', 'tests/smoke/test_title_recognize_generated.py'
        )

        import user_provide_info.main

        self.generate_test_cases(
            user_provide_info.main, 'user_provide_info', 'tests/smoke/test_user_provide_info_generated.py'
        )
